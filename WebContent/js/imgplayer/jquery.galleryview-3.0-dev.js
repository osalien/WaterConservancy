		...
		setPositions: function() {
			...
			switch(this.opts.filmstrip_position) {
				case 'top':
					...
					dom.gv_navWrap.css({ top: navVert, right:"20px"});
				...
				case 'right':
					...
					dom.gv_navWrap.css({ bottom: navVert, right: "20px" });
...
//						  height: 100%,
	...
	*/
	$.fn.galleryView.defaults = {
		...
		transition_interval: 500, 		//INT - delay between panel/frame transitions (in milliseconds)
